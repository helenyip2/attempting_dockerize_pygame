...
# Inport random for random numbers
import random
# import pygame.local for easier acces to key coordinates
...
# The surface you draw on the screen is nowan attribute of 'enemy'
...
# Define the cloud object by entending pygame.sprite.Sprite
...
# Setup for music and sound playback. Defulats are good.
#pygame.mixer.init()
...
# - clouds it just to hold all the clouds
...
while running:
	...
	# Update enemey position and cloud
	enemies.update()
	clouds.update()

	# Fill in the screen in sky blue
	...
	# Check if any enemies have coliided with the player
	if pygame.sprite.spritecollideany(player, enemies):
		# If so, then remove the player and stop the loop
		player.kill()

		# Stop any movign sounds, music, and play collision sound
		#move_up_sound.stop()
